...
export default async function WmsDashboard() {
    ...
    return (
        <div className="p-8 max-w-7xl mx-auto">
            <div className="mb-8">
                <h1 className="text-3xl font-black text-gray-900 tracking-tight">Depo Yönetim Sistemi (WMS)</h1>
                    ...
                    <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
                        <table className="w-full text-left">
                            ...
                            <tbody className="divide-y divide-gray-50">
                                {(summary as any).ordersToPrepare?.map((o: any) => (
                                ...
                                {(summary as any).ordersToPrepare?.length === 0 && (
                                    <tr>
