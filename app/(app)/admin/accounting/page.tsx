    ...
    return (
        <div className="p-8 max-w-7xl mx-auto">
            <div className="mb-8">
                ...
                <p className="text-gray-500 mt-2">Müşterilerinizi, tedarikçilerinizi ve tüm finansal hareketlerinizi buradan yönetin.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-12">
                ...
                <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm transition-all hover:shadow-md">
                    ...
                    <div className="text-2xl font-black text-gray-900 border-t pt-1 mt-1">{(summary.totalReceivables - summary.totalPayables + summary.totalCash).toLocaleString('tr-TR', { minimumFractionDigits: 2 })} TL</div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                ...
                <Link href="/admin/accounting/customers" className="group bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-indigo-500/10 transition-all duration-300">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">Müşteriler</h3>
                    <p className="text-sm text-gray-500 mt-2">Satış yaptığınız kişi ve kurumların cari hesaplarını takip edin.</p>
                </Link>
                ...
                <Link href="/admin/accounting/suppliers" className="group bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-emerald-500/10 transition-all duration-300">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">Tedarikçiler</h3>
                    <p className="text-sm text-gray-500 mt-2">Mal ve hizmet aldığınız firmaların ödemelerini ve borçlarını yönetin.</p>
                </Link>
                ...
                <Link href="/admin/accounting/ledger" className="group bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-amber-500/10 transition-all duration-300">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">Kasa & Banka</h3>
                    <p className="text-sm text-gray-500 mt-2">Nakit ve banka hesaplarınızdaki para hareketlerini izleyin.</p>
                </Link>
            </div>
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
                <div className="p-8 border-b border-gray-50 flex justify-between items-center">
                    ...
                    <div className="text-xs font-bold text-gray-400 uppercase tracking-widest bg-gray-50 px-3 py-1 rounded-full">En Aktif 10 Cari</div>
                </div>
                <div className="overflow-x-auto">
                    <table className="w-full text-left">
                        <thead className="bg-gray-50/50 text-[10px] font-black text-gray-400 uppercase tracking-widest">
                            <tr>
                                <th className="px-8 py-4">Firma / İsim</th>
                                <th className="px-8 py-4">Tür</th>
                                <th className="px-8 py-4 text-right">Güncel Bakiye</th>
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {summary.activeContacts.map((c: any) => (
                                <tr key={c.id} className="text-sm hover:bg-gray-50 transition-all group">
                                    ...
                                    <td className="px-8 py-4">
                                        <span className={`px-2 py-0.5 rounded-md text-[10px] font-bold ${c.type === 'customer' ? 'bg-indigo-50 text-indigo-600' : 'bg-emerald-50 text-emerald-600'
                                            }`}>
                            ...
                            {summary.activeContacts.length === 0 && (
                                <tr>
                                    <td colSpan={4} className="px-8 py-12 text-center text-gray-400 italic">Bu ay henüz bir işlem kaydı bulunmuyor.</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
